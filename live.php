...
<div class="row">
  <div class="column" style="background-color:#8c7853;">
  <span style="align:left">
<form action="insert2.php" name="uform"  method="get" name="myForm" onsubmit="return validateForm()">
<label for="pst1"><b><h2>Question here</h2></b></label>
...
<br>
<a href="index.php" style="vertical-align: bottom; text-decoration:none;"><button>Exit</button></a>
<?php
